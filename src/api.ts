...
export const updateProfile = (data: { fullName: string; email: string; phone: string; address: string; profileImage?: string | null }) => API.patch("/auth/me", data);
...
export const placeOrder = (data: { addressId: string; paymentMethod: "COD" | "GCash" }) => API.post("/orders", data);
